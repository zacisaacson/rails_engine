...
describe "Invoices items page" do
  it "can show all items on an invoice" do
    ...
    invoice_item_1 = create(:invoice_item, item_id: item_1.id, invoice_id: invoice_1.id, unit_price: 1892)

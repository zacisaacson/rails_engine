...
describe "Items, invoices-item page" do
  it "can show all invoice_items of certain item" do
    ...
    invoice_item_3 = create(:invoice_item, item_id: item_4.id, invoice_id: invoice_3.id, quantity: 4)
    invoice_item_4 = create(:invoice_item, item_id: item_4.id, invoice_id: invoice_4.id, quantity: 4)

    get "/api/v1/items/#{item_4.id}/invoice_items"
